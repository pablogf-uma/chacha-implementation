...
chacha20: chacha20.o quarter_round.o state_init.o permute_state.o encrypt.o
	gcc chacha20.o quarter_round.o state_init.o permute_state.o encrypt.o -o chacha20
...
clean: # Used to remove all files generated by the build process.
	cmd /C del /Q chacha20.exe chacha20.o quarter_round.o state_init.o permute_state.o encrypt.o
