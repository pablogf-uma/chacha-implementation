...
OBJS = chacha20.o quarter_round.o state_init.o permute_state.o encrypt.o run_encrypt_test.o calculate_throughput.o decrypt.o run_decrypt_test.o encrypt_custom_input.o decrypt_custom_input.o # These are all the .o files required to generate the executable
